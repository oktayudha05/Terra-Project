export default function Intro() {
  return (
    <section className="text-white">
      <div className="px-4 pt-20 md:py-40">
        <div className="mx-auto max-w-3xl text-center sm:text-start">
          ...
          <div className="mt-4 mb-4 sm:mb-0 sm:mt-8 flex flex-wrap justify-center sm:justify-start gap-4">
            <a
              className="block w-auto rounded border border-blue-600 bg-blue-600 px-6 sm:px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-white focus:outline-none focus:ring active:text-opacity-75 sm:w-auto"
              href="#"
            >
              Get Started
            </a>
            <a
              className="block w-auto rounded border border-blue-600 px-6 sm:px-12 py-3 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto"
              href="#"
            >
              Learn More
            </a>
